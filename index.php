...
<head>
  ...
  <title>Koperasi Simpan Pinjam Sehati Makmur Abadi</title>
...
<section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      ?>
            ...
            <!--logo start-->
            <a href="#" class="logo">Koperasi Sehati | <?php echo $_SESSION['level'];?></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
            ...
            <li><a href="index.php?pilih=4.3"><i class="glyphicon glyphicon-user"></i> Setting User</a></li>
              ...
              ?>
              <hr>
              <center>Skripsi | M.Ivan Fadilah 17.3.0.0058</a>
              </center>
              <!-- sidebar menu end-->
          </div>
      </aside>
